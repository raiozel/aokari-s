...
("undefined" != typeof window ? window : this, function(a, b) {
	...
	var t = function(a) {
		...
		c = fa.support = {}, f = fa.isXML = function(a) {
			...
			m = fa.setDocument = function(a) {
				...
				return g !== n && 9 === g.nodeType && g.documentElement ? (n = g, o = n.documentElement,
					...
					(c.matchesSelector = Z.test(s = o.matches || o.webkitMatchesSelector || o.mozMatchesSelector || o.oMatchesSelector || o.msMatchesSelector)) && ia(function(a) {
						c
							.disconnectedMatch = s.call(a, "div"), s.call(a, "[s!='']:x"), r.push("!=", O)
					}),
			...
			d = fa.selectors = {
				...
				preFilter: {
					...
					PSEUDO: function(a) {
						var b, c = !a[6] && a[2];
						return W.CHILD.test(a[0]) ? null : (a[3] ? a[2] = a[4] || a[5] || "" : c && U.test(c) && (b = g(c, !0)) && (b = c.indexOf(")",
		...
		pa.prototype = d.filters = d.pseudos,
			d.setFilters = new pa, g = fa.tokenize = function(a, b) {
				...
				if (c = d.relative[a[i].type]) m = [ra(sa(m), c)];
					...
					if (c = d.filter[a[i].type].apply(null, a[i].matches), c[u]) {
						...
						return va(i > 1 && sa(m), i > 1 && qa(a.slice(0, i - 1).concat({
							...
							.replace(Q, "$1"), c, e > i && wa(a.slice(i, e)),
	...
	n.fn.extend({
		...
		index: function(a) {
			return a ? "string" == typeof a ? h.call(n(a),
				this[0]) : h.call(this, a.jquery ? a[0] : a) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
		},
		add: function(a, b) {
	...
	n.extend(n.event, {
		trigger: function(b, c, e, f) {
			...
			if (h = i = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !ib.test(q + n.event.triggered) && (q.indexOf(".") > -1 && (r = q.split("."), q = r.shift(), r.sort()),
					l = q.indexOf(":") < 0 && "on" + q, b = b[n.expando] ? b : new n.Event(q, "object" == typeof b && b), b.isTrigger = f ? 2 : 3, b.namespace = r.join("."), b.rnamespace = b.namespace ? new RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = e), c = null == c ? [b] : n.makeArray(c, [b]),
				...
				g = 0;
				while ((h = p[g++]) && !b.isPropagationStopped()) b.type = g > 1 ? j : o.bindType || q, m = (N.get(h, "events") || {})[b.type] && N.get(h, "handle"),
					m && m.apply(h, c), m = l && h[l], m && m.apply && L(h) && (b.result = m.apply(h, c), b.result === !1 && b.preventDefault());
				return b.type = q,
					f || b.isDefaultPrevented() || o._default && o._default.apply(p.pop(), c) !== !1 || !L(e) || l && n.isFunction(e[q]) && !n.isWindow(e) && (i = e[l], i && (e[l] = null),
						n.event.triggered = q, e[q](), n.event.triggered = void 0, i && (e[l] = i)), b.result
			}
		},
